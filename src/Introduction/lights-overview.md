...
Indicator, caution, and warning lights are placed throughout the cockpit in order to notify the pilot of the status of systems. Each category has a different meaning.
...
| NAVS AIR OVERHEAT | Caution | ** DIFFERENCE B/W THIS AND ABOVE?? **| |
...
| Light | Category | Cause | Procedure |
|-------|----------|-------|-----------|
| CANOPY NOT LOCKED | Warning | The canopy is not closed and locked | |
